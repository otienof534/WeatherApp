...
space = Label(x, text=' ', bg='purple').grid(row=4,column=0)
...
condition.grid(row=5,column=0)

temp_defn = Label(x,text="Temperature:",font=('Times New Roman',12),bg="black",fg="white").grid(row=1,column=0)
humidity_defn =Label(x,text="Humidity:",font=('Times New Roman',12),bg='black',fg='white').grid(row=2,column=0)
pressure_defn = Label(x,text="Pressure:",font=('Times New Roman',12),bg='black',fg='white').grid(row=3,column=0)


entry_defn_bg = PhotoImage(file="Images\\logo.png")
Label(x,image=entry_defn_bg,bg="purple").grid(row=0,column=0)
entry_defination = Label(x,text= 'County/Town:').grid(row=0,column=0)
...
def RESULTS():
    ...
    weather_result1.grid(row=5,column=1)
    weather_result2 = Label(x, text=weather_data['main']['temp'],
                            font=("Times New Roman", 15, "bold", 'italic'), bg="purple", fg='white')
    weather_result2.grid(row=1, column=1)
    weather_result3 = Label(x, text=weather_data['main']['humidity'],
                            font=("Times New Roman", 15, "bold", 'italic'), bg="purple", fg='white')
    weather_result3.grid(row=2, column=1)
    weather_result1 = Label(x, text=weather_data['main']['pressure'],
                            font=("Times New Roman", 15, "bold", 'italic'), bg="purple", fg='white')
    weather_result1.grid(row=3, column=1)
